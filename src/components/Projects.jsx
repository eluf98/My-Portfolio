...
export function Projects() {
    ...
    <section className={darkMode ? "dark bg-[#484148]" : "bg-white"}>
      <div className="flex flex-col justify-center items-center pt-24 pb-16 px-4 sm:px-8 md:px-16">
        <label
        ...
        <div className="flex gap-16 w-full ">
          <div className="flex flex-wrap gap-16 justify-center w-full ">
            {projectsInformation.map((item, index) => (
              <div
                key={item.id}
                className={`w-[35rem] h-[40rem] rounded-lg ${projectCardBackground(index)}`}
              >
                <div className="ml-10 mt-10 sm:ml-10 sm:mt-10">
                  <label
