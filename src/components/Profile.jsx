    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      >
        ...
        <section className="flex flex-col sm:flex-row gap-14 sm:gap-8 max-[960px]:gap-6">
          ...
          <div
            className={`relative z-30 flex flex-col gap-6 rounded-2xl border-none w-[37rem] h-[22rem] ${darkMode ? "bg-[#525252]" : "bg-white"} max-[960px]:w-full max-[960px]:h-auto`}
          >
            ...
            <div className="flex flex-col sm:flex-row gap-8 ml-12 max-[960px]:ml-4 max-[960px]:mb-4">
