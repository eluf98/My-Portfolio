...
export function Profile() {
    ...
    return (
      <div className={darkMode ? "dark" : ""}>
        ...
        >
          <h1 className={`font-semibold text-[3rem] mt-16 mb-8 ${darkMode ? "text-white" : "text-black"}`}>
            {language === TURKISH
          ...
          <section className="flex flex-row gap-14">
            ...
            ></div>
            <div
              className={`relative z-30 flex flex-col gap-6 rounded-2xl border-none w-[37rem] h-[22rem] ${darkMode ? "bg-[#525252]" : "bg-white"}`}
            >
              <div className="ml-12 mt-8">
                <label className={`text-[2rem] text-[#EA2678]`}>
                  {language === TURKISH
