...
export function Information() {
    ...
    return (
        <section className={darkMode ? "dark bg-[#2A262B] dark:text-white" : "bg-gray-200"}>
            <div className={darkMode ? "dark bg-[#2A262B]" : "bg-gray-200"}>
            <div className={`flex flex-col mx-40 ${darkMode ? "dark:bg-[#2A262B]" : "bg-gray-200"} ${darkMode ? "dark:text-white" : "text-black"}`}>
                <div className="mb-4">
